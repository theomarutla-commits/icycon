...
export const featureList: FeatureConfig[] = [
  {
    ...
    primaryCta: { label: 'View SEO Data', href: '/' },
  ...
  },
  {
    ...
    primaryCta: { label: 'Try Translation', href: '/#/auth' },
    secondaryCta: { label: 'See FAQs', href: '/' },
  ...
  },
  {
    ...
    primaryCta: { label: 'Connect Social Data', href: '/#/auth' },
    secondaryCta: { label: 'View Posts', href: '/' },
  ...
  },
  {
    ...
    primaryCta: { label: 'View Email Data', href: '/#/auth' },
    secondaryCta: { label: 'Marketing Overview', href: '/#/auth' },
  ...
  },
  {
    ...
    primaryCta: { label: 'Translate Content', href: '/#/auth' },
    secondaryCta: { label: 'View Multilingual Data', href: '/' },
  ...
  },
  {
    ...
    primaryCta: { label: 'View Backlinks', href: '/#/auth' },
    secondaryCta: { label: 'See Directories', href: '/#/auth?mode=login' },
  ...
  },
  {
    ...
    primaryCta: { label: 'Manage Directories', href: '/#/auth' },
  ...
  },
  {
    ...
    primaryCta: { label: 'Spin Up a Microtool', href: '/#/auth' },
    secondaryCta: { label: 'Back to Services', href: '/#/services' },
  ...
  },
  {
    ...
    primaryCta: { label: 'View ASO Data', href: '/#/auth' },
    secondaryCta: { label: 'See Marketplace', href: '/#/auth' },
  ...
  },
  {
    ...
    primaryCta: { label: 'View Marketplace Data', href: '/#/auth' },
    secondaryCta: { label: 'Back to Services', href: '/#/services' },
  ...
  },
  {
    ...
    primaryCta: { label: 'Plan Content', href: '/#/auth' },
    secondaryCta: { label: 'Translate Copy', href: '/#/auth' },
