...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[55vh] flex-col items-center justify-center overflow-hidden bg-slate-50 dark:bg-icy-dark w-full rounded-md z-0 transition-colors duration-300",
        className
      )}
    >
