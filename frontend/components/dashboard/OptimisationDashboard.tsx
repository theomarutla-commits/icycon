      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 rounded-2xl bg-white dark:bg-[#002466]/40 border border-gray-200 dark:border-white/10 shadow-sm">
          <div className="flex justify-between items-start mb-2">
            ...
            <span className="p-2 bg-green-500/10 text-green-500 rounded-lg"><Activity size={16} /></span>
          </div>
        ...
        <div className="p-6 rounded-2xl bg-white dark:bg-[#002466]/40 border border-gray-200 dark:border-white/10 shadow-sm">
          <div className="flex justify-between items-start mb-2">
            ...
            <span className="p-2 bg-blue-500/10 text-blue-500 rounded-lg"><Search size={16} /></span>
          </div>
        ...
        <div className="p-6 rounded-2xl bg-white dark:bg-[#002466]/40 border border-gray-200 dark:border-white/10 shadow-sm">
          <div className="flex justify-between items-start mb-2">
            ...
            <span className="p-2 bg-purple-500/10 text-purple-500 rounded-lg"><MousePointer size={16} /></span>
          </div>
          ...
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={trafficData}>
                ...
                />
                <Area type="monotone" dataKey="traffic" stroke="#4092ef" fillOpacity={1} fill="url(#colorTraffic)" />
          ...
          <div className="h-[300px] w-full">
             <ResponsiveContainer width="100%" height="100%">
              <LineChart data={historicalData}>
                ...
                <YAxis yAxisId="right" orientation="right" axisLine={false} tickLine={false} tick={{fill: '#94a3b8', fontSize: 12}} reversed />
                <Tooltip 
                   contentStyle={{ backgroundColor: '#1e293b', border: 'none', borderRadius: '8px', color: '#fff' }}
                />
                <Legend />
              ...
              <tbody>
                {keywords.map((k, i) => (
                  <tr key={i} className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                    <td className="px-4 py-3 font-medium text-gray-900 dark:text-white">{k.term}</td>
          ...
          <div className="overflow-x-auto">
             <table className="w-full text-sm text-left">
              ...
              <tbody>
                {queries.map((q, i) => (
                  <tr key={i} className="border-b border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                    <td className="px-4 py-3 font-medium text-gray-900 dark:text-white">{q.query}</td>
