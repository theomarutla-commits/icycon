    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <div key={i} className="p-6 rounded-2xl bg-white dark:bg-[#002466]/40 border border-gray-200 dark:border-white/10 shadow-sm hover:shadow-md transition-shadow">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 p-6 rounded-2xl bg-white dark:bg-[#002466]/40 border border-gray-200 dark:border-white/10 shadow-sm">
          <div className="mb-6 flex justify-between items-center">
            ...
            <select className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg px-3 py-1 text-sm text-gray-600 dark:text-gray-300 focus:outline-none">
        ...
        <div className="lg:col-span-1 p-6 rounded-2xl bg-white dark:bg-[#002466]/40 border border-gray-200 dark:border-white/10 shadow-sm">
          <div className="mb-6 flex justify-between items-center">
            ...
            <span className="px-2 py-1 bg-red-500/10 text-red-500 rounded text-xs font-bold">3 Pending</span>
          </div>
          <div className="space-y-3">
            {marketplaceMessages.map((msg, i) => (
              <div key={i} className="p-4 rounded-xl bg-gray-50 dark:bg-white/5 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors cursor-pointer border border-transparent hover:border-gray-200 dark:hover:border-white/10">
          ...
          <button className="w-full mt-4 py-2 text-sm font-medium text-gray-500 hover:text-icy-main transition-colors">
            View All Messages
          </button>
        </div>
      </div>
        ...
        <div className="mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <input 
              ...
              className="px-4 py-2 rounded-lg bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-sm focus:outline-none focus:border-icy-main w-full sm:w-auto"
            />
            <button className="px-4 py-2 bg-icy-main text-white rounded-lg text-sm font-bold hover:bg-icy-secondary transition-colors">Filter</button>
          </div>
        </div>
                  ...
                  <td className="px-4 py-3">
                    <span className={`px-2 py-1 rounded-full text-xs font-bold flex w-fit items-center gap-1
                      ${order.status === 'Shipped' ? 'bg-green-100 text-green-700' : 
                        ...
                        'bg-red-100 text-red-700' // Return Req
                      }
                    `}>
