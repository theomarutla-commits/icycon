                ...
                <div className="h-[350px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                        <ComposedChart data={historicalData}>
                            ...
                            <YAxis yAxisId="left" axisLine={false} tickLine={false} tick={{fill: '#9ca3af'}} label={{ value: 'Traffic', angle: -90, position: 'insideLeft', fill: '#9ca3af' }} />
                            <YAxis yAxisId="right" orientation="right" axisLine={false} tickLine={false} tick={{fill: '#9ca3af'}} reversed label={{ value: 'Rank', angle: 90, position: 'insideRight', fill: '#9ca3af' }} />
                ...
                <div className="h-[250px] w-full">
                    <ResponsiveContainer width="100%" height="100%">
                        <AreaChart data={trafficData}>
                            ...
                            <Tooltip contentStyle={{ backgroundColor: '#1e293b', border: 'none', borderRadius: '8px', color: '#fff' }} />
                            <Area type="monotone" dataKey="traffic" stroke="#10b981" fillOpacity={1} fill="url(#colorOrgTraffic)" />
                        </AreaChart>
                    </ResponsiveContainer>
                </div>
            </div>
