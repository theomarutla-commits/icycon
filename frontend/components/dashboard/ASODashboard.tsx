      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 p-6 rounded-2xl bg-white dark:bg-[#002466]/40 border border-gray-200 dark:border-white/10 shadow-sm">
           <div className="mb-6 flex items-center justify-between">
              ...
              <span className="text-xs px-2 py-1 rounded bg-green-500/20 text-green-500 font-bold">Live</span>
           </div>
           <p className="text-sm text-gray-500 mb-4">Experiment: New Screenshots</p>
           
           <div className="space-y-4">
              <div className="p-4 rounded-xl bg-gray-50 dark:bg-white/5 border border-green-500/50 relative overflow-hidden">
           ...
           <button className="w-full mt-6 py-2 rounded-lg bg-icy-main text-white font-bold text-sm">
              Apply Winner
           </button>
        </div>
